...
public class TestRunner {
    ...
    public void testLogin() {
        new LoginTest(driver).execute();
    }

    @Test
    public void testNavigation() {
        new NavigationTest(driver).execute();
    }
...
// === ARCHIVO: src/test/java/com/pragma/tests/ui/LoginTest.java ===
...
// === ARCHIVO: src/test/java/com/pragma/tests/ui/NavigationTest.java ===
package com.pragma.tests.ui;
...
// === ARCHIVO: src/test/resources/testData.properties ===
username=testuser
password=testpass
// === ARCHIVO: reports/test-report.xml ===
<?xml version="1.0" encoding="UTF-8"?>
<test-report>
    <test name="LoginTest" status="PASS" />
    <test name="NavigationTest" status="PASS" />
</test-report>
```
